...
public class DeliveryOrderServiceImpl implements DeliveryOrderService {
	...
	public String confirm(JSONObject jsonData) {
		...
		String ftid = UUID.randomUUID().toString().toUpperCase();
		...
		exe1.put("FTID", ftid);
		exe1.put("FUID", "qimen");
		exe1.put("FUNIT_NAME", "奇门接口");
		exe1.put("FUNIT_ID", "qimen");
		exe1.put("FACTION_ID", "qimen");
		exe1.put("FACTION_NAME", "奇门接口");
		...
		return httpClientHelper.sendJsonHttpPost(url, JSON.toJSONString(req).trim());
	}
